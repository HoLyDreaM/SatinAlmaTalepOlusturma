<%@ Page Language="C#" AutoEventWireup="true" CodeFile="idariKisimihtiyacListesi.aspx.cs" Inherits="Formlar_idariKisimihtiyacListesi" %>
...
<head id="Head1" runat="server">
    <title>İdari Kısım İhtiyaç Listesi</title>
...
<table width="1200" border="0">
  <tr>
    <td align="center" scope="col" style="font-family:Calibri; font-size:17px; font-weight:bold;border:1px solid Black; height:30px;">İDARİ KISIM İHTİYAÇ LİSTESİ</td>
  </tr>
</table>
<table width="1200" border="0">
  <tr>
...
<asp:Panel ID="panelidariListe" runat="server"></asp:Panel>
</table>
<table width="1200" border="0">
  <tr>
