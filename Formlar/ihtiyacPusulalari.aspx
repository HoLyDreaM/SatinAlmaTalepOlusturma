<%@ Page Title="" Language="C#" MasterPageFile="~/Anasayfa.master" AutoEventWireup="true" CodeFile="ihtiyacPusulalari.aspx.cs" Inherits="Formlar_ihtiyacPusulalari" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table align="center" class="auto-style1">
         ...
         <br /><center><fieldset style="width:85%">
    <asp:Panel ID="panelihtiyaclarimiz" runat="server"></asp:Panel>
    </fieldset></center>
</asp:Content>
