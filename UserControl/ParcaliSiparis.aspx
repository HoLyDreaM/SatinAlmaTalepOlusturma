<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ParcaliSiparis.aspx.cs" Inherits="ParcaliSiparis" %>
...
<table border="0" style="width:950px">
  ...
  <tr>
    ...
    <td scope="row" class="auto-style1"><dx:ASPxButton ID="btnParcaliSiparis" runat="server" Text="Parçalı Sipariş Aç" Width="150px" OnClick="btnParcaliSiparis_Click"></dx:ASPxButton></td>
    <td scope="row" width="175" align="center"><asp:CheckBox ID="chkTalepKapat" runat="server" Text="Talepleri Kapat" /></td>
    ...
    <asp:Table ID="tabloSiparis" runat="server" Width="76%">
            ...
            SelectCommand="SELECT [CAR002_HesapKodu] as HesapKodu, [CAR002_Unvan1] as Unvan FROM [CAR002]">
        </asp:SqlDataSource>
